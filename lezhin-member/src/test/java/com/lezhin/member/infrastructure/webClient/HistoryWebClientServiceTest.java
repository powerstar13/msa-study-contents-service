...
class HistoryWebClientServiceTest {
    ...
    @DisplayName("이력 삭제")
    @Test
    void historyDeleteByMemberDelete() throws JsonProcessingException {
        ...
        Mono<CommonResponse> result = historyWebClientService.historyDeleteByMemberDelete(RandomUtils.nextLong());
