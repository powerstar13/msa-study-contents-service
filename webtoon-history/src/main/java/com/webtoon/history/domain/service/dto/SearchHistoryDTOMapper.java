...
public interface SearchHistoryDTOMapper {
    ...
    @Mappings({
        @Mapping(expression = "java(com.webtoon.history.domain.MemberType.valueOf(String.valueOf(history.get(\"memberType\"))))", target = "memberType"),
        ...
        @Mapping(expression = "java(com.webtoon.history.domain.MemberGender.valueOf(String.valueOf(history.get(\"memberGender\"))))", target = "memberGender")
    })
